package com.example.crypto.features.coinActivity.marketActivity
...
import com.example.crypto.features.coinActivity.CoinActivity
...
class MarketActivity : AppCompatActivity(), MarketAdapter.RecyclerCallback {
    ...
    private fun firstRunShowDialogWelcome() {
        ...
        if (isFirstRun) {
            ...
            dialog.setMessage("بیت کوین وعده می\u200Cدهد که حداقل برخی از قدرت\u200Cها را از دولت ها گرفته و آن را به مردم انتقال دهد. این به تنهایی باعث درگیری های سیاسی، فرهنگی و اقتصادی می\u200Cشود.")
            dialog.show()
